...
try:
    ...
    raise ImportError("Error occured while running `from pyglet.gl import *` HINT: make sure you have OpenGL install. "
    ...
    #               "If you're running on a server, you may need a virtual frame buffer; something like this "
...
class Viewer(object):
    ...
    def render(self, return_rgb_array=False):
        ...
        if return_rgb_array:
            ...
            arr = np.fromstring(image_data.get_data('RGBA'), dtype=np.uint8, sep='')
